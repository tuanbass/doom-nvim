...
--     "repl", -- Interactive REPL in neovim
      -- "explorer", -- An enhanced filetree explorer - not work with vscode yet
...
-- --     -- "suda",            -- Save using sudo when necessary
    -- "telescope", -- Fuzzy searcher to find files, grep code and more i, not work with vscode yet
    -- "whichkey", -- An interactive sheet
-- --     ------------------- user module
    "navigation",
--     "git",   -- Not work with vscode yet
    "views",
--    "fold",
--    "refactor",
--     "entertainments",
--     "scratch",
    -- "github", -- Not work with vscode yet
